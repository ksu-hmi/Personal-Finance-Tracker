...
@login_required
def dashboard():
    # Fetch user transactions and goals
    ...
    return render_template('dashboard.html', income=income, expenses=expenses, balance=balance, chart_url=chart_url, goals=goals, transactions=transactions, current_amount=current_amount)
